<template>
  <section id="hero">
      ...
      <v-col cols="12" md="6" align-self="center" class="pl-0 pl-md-16 mt-16 mt-md-0">
        <v-container class="text-hero ml-lg-16" style="width: 75%;">
          ...
          <v-row class="mt-4 w-auto" justify="start" align="center" dense>
            ...
            <v-img src="@/assets/img/tripadvisor.png" height="18" />
          </v-row>
        </v-container>
      </v-col>
    ...
    <div class="blur1">
      <svg width="441" height="481" viewBox="0 0 441 481" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="blur2">
      <svg width="688" height="396" viewBox="0 0 688 396" fill="none" xmlns="http://www.w3.org/2000/svg">
