...
export default {
    ...
    data: () => ({
        articles: [
            ...
            {
                thumbNail: 'article3.jpeg',
                authorImg: 'avatar8.jpeg',
